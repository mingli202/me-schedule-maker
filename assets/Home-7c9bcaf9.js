import{j as u,L as G,r as T,u as L,a as U,F as Z,f as Be,b as _t,c as yt,d as Tt,E as he,_ as d,e as _,g as N,h,i as y,S as fe,k as pe,q as ve,l as me,m as Ee,C as Pe,n as Re,o as Je,p as wt,s as bt,t as kt,v as Nt,w as E,x as ee,y as Et,z as Pt,A as Rt,B as q,D as H,G as St,H as Ct,I as At,J as xt,K as Ot,M as Lt,N as se,O as Ut,P as $e,U as Mt,Q as Dt,$ as jt}from"./index-5d84b5cc.js";import{V as Ft}from"./View-bdf91099.js";function Vt(){return u.jsx("div",{className:"absolute w-full h-full top-0 left-0 -z-10"})}function qt({setIndex:n,viewData:e,uid:t,currentIndex:r}){return u.jsxs("section",{className:"flex flex-col justify-between relative row-span-full col-start-8 col-span-2 rounded-lg overflow-hidden",children:[u.jsx("div",{className:"relative max-h-full rounded-lg box-border bg-c1 p-2 flex flex-col overflow-auto",children:e?e.map((i,s)=>u.jsx(Ht,{data:i,index:s,setIndex:n,uid:t,currentIndex:r},s)):"Open the editor to make a new schedule"}),u.jsx(G,{to:"schedule",className:"w-full flex justify-center",children:u.jsx("button",{className:"text-c1 hover:font-bold transition",children:"Open Editor"})})]})}function Ht({data:n,setIndex:e,index:t,uid:r,currentIndex:i}){const[s,o]=T.useState(!1),[a,c]=T.useState(""),[f,l]=T.useState(n.name??`Untitled ${t+1}`);function p(w){w.stopPropagation(),s?l(a):c(f),o(b=>!b)}async function g(w){w.preventDefault(),o(!1),r&&await _t(r,f,t)}const I=L({backgroundColor:i===t?"#03045e":"#caf0f8",color:i!==t?"#03045e":"#caf0f8"});return u.jsxs(U.div,{onClick:()=>!s&&e(t),className:"relative cursor-pointer w-full px-2 py-4 rounded hover:font-bold flex items-center",style:I,children:[u.jsx(Z,{icon:Be,className:"pr-2 hover:text-c5 transition cursor-pointer",onClick:p}),s?u.jsxs("form",{onSubmit:w=>void g(w),className:"w-full",children:[u.jsx("input",{className:"outline-none rounded p-2 w-full text-c9",value:f,onChange:w=>l(w.target.value)}),u.jsx("input",{type:"submit",className:"hidden"})]}):f,t===0?null:u.jsx("div",{className:"absolute mx-1 w-[calc(100%-0.5rem)] h-[2px] bg-c5 -top-[1px] left-0"})]},n.id)}function Wt(){return u.jsxs("div",{className:"basis-full box-border flex flex-col items-center justify-center gap-2",children:[u.jsx("h1",{className:"text-7xl font-bold text-c9",children:"Welcome!"}),u.jsx("p",{className:"font-bold text-xl",children:"Ready to make your dream schedule?"}),u.jsxs("div",{className:"flex gap-2 mt-4",children:[u.jsx("button",{onClick:()=>{var n;return(n=document.getElementById("schedules"))==null?void 0:n.scrollIntoView({behavior:"smooth"})},className:"text-c5 hover:underline",children:"Check current schedules"}),u.jsx(G,{to:"schedule",children:u.jsxs("button",{className:"text-c1 mr-4 hover:bg-c1 hover:text-c9 transition bg-c9 p-2 rounded",children:["New ",u.jsx(Z,{icon:yt})]})})]})]})}function Kt({user:n,setNavDisplayName:e}){const[t,r]=T.useState(!1),[i,s]=T.useState((n==null?void 0:n.displayName)??(n==null?void 0:n.email)??"User"),[o,a]=T.useState("");T.useEffect(()=>{n&&s(n.displayName??n.email??"User")},[n]);function c(l){l.preventDefault(),r(!1),e(i),n&&Tt(n,{displayName:i}).catch(p=>console.log(p))}function f(l){l.stopPropagation(),t?s(o):a(i),r(p=>!p)}return u.jsxs("div",{className:"rounded-xl border border-c9 border-solid p-4 transition hover:bg-c8 hover:text-c2",children:[u.jsx("h2",{className:"font-semibold text-xl",children:"Display Name"}),u.jsx("p",{children:"This name will be displayed instead of your email at the top"}),u.jsxs("div",{className:"mt-4 flex items-center",children:[u.jsx(Z,{icon:Be,className:"pr-2 hover:text-c5 transition cursor-pointer",onClick:f}),t?u.jsxs("form",{className:"w-full",onSubmit:l=>void c(l),children:[u.jsx("input",{className:"outline-none rounded p-2 w-full text-c9",value:i,onChange:l=>s(l.target.value)}),u.jsx("input",{type:"submit",className:"hidden"})]}):i]})]})}var Se="__sak";function Ce(n){return n!==void 0&&n.enterprise!==void 0}var Gt=function(){function n(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(function(t){return t.provider==="EMAIL_PASSWORD_PROVIDER"&&t.enforcementState!=="OFF"})}return n}();function Ye(){var n;return n={},n["dependent-sdk-initialized-before-auth"]="Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK.",n}var zt=Ye,le=new he("auth","Firebase",Ye());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wn(n,e){return e===void 0&&(e={}),d(this,void 0,void 0,function(){return h(this,function(t){return[2,V(n,"GET","/v2/passwordPolicy",A(n,e))]})})}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}function Pn(n){return new Promise(function(e,t){var r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=function(i){var s=te("internal-error");s.customData=i,t(s)},r.type="text/javascript",r.charset="UTF-8",En().appendChild(r)})}var Rn="https://www.google.com/recaptcha/enterprise.js?render=",Sn="recaptcha-enterprise",Cn="NO_RECAPTCHA",An=function(){function n(e){this.type=Sn,this.auth=ut(e)}return n.prototype.verify=function(e,t){return e===void 0&&(e="verify"),t===void 0&&(t=!1),d(this,void 0,void 0,function(){function r(o){return d(this,void 0,void 0,function(){var a=this;return h(this,function(c){if(!t){if(o.tenantId==null&&o._agentRecaptchaConfig!=null)return[2,o._agentRecaptchaConfig.siteKey];if(o.tenantId!=null&&o._tenantRecaptchaConfigs[o.tenantId]!==void 0)return[2,o._tenantRecaptchaConfigs[o.tenantId].siteKey]}return[2,new Promise(function(f,l){return d(a,void 0,void 0,function(){return h(this,function(p){return rn(o,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(function(g){if(g.recaptchaKey===void 0)l(new Error("recaptcha Enterprise site key undefined"));else{var I=new Gt(g);return o.tenantId==null?o._agentRecaptchaConfig=I:o._tenantRecaptchaConfigs[o.tenantId]=I,f(I.siteKey)}}).catch(function(g){l(g)}),[2]})})})]})})}function i(o,a,c){var f=window.grecaptcha;Ce(f)?f.enterprise.ready(function(){f.enterprise.execute(o,{action:e}).then(function(l){a(l)}).catch(function(){a(Cn)})}):c(Error("No reCAPTCHA enterprise script loaded."))}var s=this;return h(this,function(o){return[2,new Promise(function(a,c){r(s.auth).then(function(f){if(!t&&Ce(window.grecaptcha))i(f,a,c);else{if(typeof window>"u"){c(new Error("RecaptchaVerifier is only supported in browser"));return}Pn(Rn+f).then(function(){i(f,a,c)}).catch(function(l){c(l)})}}).catch(function(f){c(f)})})]})})},n}();function je(n,e,t,r){return r===void 0&&(r=!1),d(this,void 0,void 0,function(){var i,s,o;return h(this,function(a){switch(a.label){case 0:i=new An(n),a.label=1;case 1:return a.trys.push([1,3,,5]),[4,i.verify(t)];case 2:return s=a.sent(),[3,5];case 3:return a.sent(),[4,i.verify(t,!0)];case 4:return s=a.sent(),[3,5];case 5:return o=y({},e),r?Object.assign(o,{captchaResp:s}):Object.assign(o,{captchaResponse:s}),Object.assign(o,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(o,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),[2,o]}})})}function xn(n,e){var t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(O);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,M(n,"POST","/v1/accounts:signInWithIdp",A(n,e))]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function er(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function tr(n){Ee(new Pe("auth",function(e,t){var r=t.options,i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),o=e.getProvider("app-check-internal"),a=i.options,c=a.apiKey,f=a.authDomain;m(c&&!c.includes(":"),"invalid-api-key",{appName:i.name});var l={apiKey:c,authDomain:f,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:at(n)},p=new Nn(i,s,o,l);return xn(p,r),p},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(function(e,t,r){var i=e.getProvider("auth-internal");i.initialize()})),Ee(new Pe("auth-internal",function(e){var t=ut(e.getProvider("auth").getImmediate());return function(r){return new Zn(r)}(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Re(He,We,er(n)),Re(He,We,"esm5")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
