import{j as u,L as G,r as _,u as R,a as x,F as Z,f as Be,b as _t,c as yt,d as Tt,E as he,_ as d,e as T,g as E,h,i as b,S as fe,k as pe,q as ve,l as me,m as Ne,C as Pe,n as Se,o as Je,p as wt,s as bt,t as kt,v as Et,w as N,x as ee,y as Nt,z as Pt,A as St,B as q,D as H,G as Rt,H as xt,I as Ct,J as At,K as Ot,M as Lt,N as se,O as Ut,P as $e,U as Mt,Q as Dt,$ as jt}from"./index-5ae4280e.js";import{V as Ft}from"./CurrentClassses-a2c5ec54.js";function Vt(){return u.jsx("div",{className:"absolute w-full h-full top-0 left-0 -z-10"})}function qt({setIndex:n,viewData:e,uid:t,currentIndex:r}){return u.jsxs("section",{className:"flex flex-col justify-between relative md:row-span-full md:col-start-8 md:col-span-2 col-span-full rounded-lg overflow-hidden max-md:order-2 md:text-base text-xs",children:[u.jsx("div",{className:"relative max-h-full rounded-lg box-border bg-c1 md:p-2 p-1 flex flex-col overflow-auto",children:e?e.map((i,s)=>u.jsx(Ht,{data:i,index:s,setIndex:n,uid:t,currentIndex:r},s)):"Open the editor to make a new schedule"}),u.jsx(G,{to:"schedule",className:"w-full flex justify-center",children:u.jsx("button",{className:"text-c1 hover:font-bold transition",children:"Open Editor"})})]})}function Ht({data:n,setIndex:e,index:t,uid:r,currentIndex:i}){const[s,o]=_.useState(!1),[a,c]=_.useState(""),[f,l]=_.useState(n.name??`Untitled ${t+1}`);function p(y){y.stopPropagation(),s?l(a):c(f),o(I=>!I)}async function g(y){y.preventDefault(),o(!1),r&&await _t(r,f,t)}const w=R({backgroundColor:i===t?"#03045e":"#caf0f8",color:i!==t?"#03045e":"#caf0f8"});return u.jsxs(x.div,{onClick:()=>!s&&e(t),className:"relative cursor-pointer w-full md:px-2 px-1 md:py-4 py-2 rounded hover:font-bold flex items-center",style:w,children:[u.jsx(Z,{icon:Be,className:"md:pr-2 pr-1 hover:text-c5 transition cursor-pointer",onClick:p}),s?u.jsxs("form",{onSubmit:y=>void g(y),className:"w-full",children:[u.jsx("input",{className:"outline-none rounded md:p-2 p-1 w-full text-c9",value:f,onChange:y=>l(y.target.value)}),u.jsx("input",{type:"submit",className:"hidden"})]}):f,t===0?null:u.jsx("div",{className:"absolute mx-1 w-[calc(100%-0.5rem)] h-[2px] bg-c5 -top-[1px] left-0"})]},n.id)}function Wt({scroll:n}){const e=R({scale:1-n/window.innerHeight});return u.jsxs(x.div,{className:"basis-full box-border flex flex-col items-center justify-center gap-2",style:e,children:[u.jsx("h1",{className:"md:text-7xl text-4xl font-bold text-c9",children:"Welcome!"}),u.jsx("p",{className:"font-bold text-base",children:"Ready to make your dream schedule?"}),u.jsxs("div",{className:"flex gap-2 mt-4 md:text-base text-sm",children:[u.jsx("button",{onClick:()=>{var t;return(t=document.getElementById("schedules"))==null?void 0:t.scrollIntoView({behavior:"smooth"})},className:"text-c5 hover:underline",children:"Check current schedules"}),u.jsx(G,{to:"schedule",children:u.jsxs("button",{className:"text-c1 mr-4 hover:bg-c1 hover:text-c9 transition bg-c9 p-2 rounded",children:["New ",u.jsx(Z,{icon:yt})]})})]})]})}function Kt({user:n,setNavDisplayName:e}){const[t,r]=_.useState(!1),[i,s]=_.useState((n==null?void 0:n.displayName)??(n==null?void 0:n.email)??"User"),[o,a]=_.useState("");_.useEffect(()=>{n&&s(n.displayName??n.email??"User")},[n]);function c(l){l.preventDefault(),r(!1),e(i),n&&Tt(n,{displayName:i}).catch(p=>console.log(p))}function f(l){l.stopPropagation(),t?s(o):a(i),r(p=>!p)}return u.jsxs("div",{className:"rounded-xl border border-c9 border-solid p-4 transition hover:bg-c8 hover:text-c2",children:[u.jsx("h2",{className:"font-semibold md:text-xl text-base",children:"Display Name"}),u.jsx("p",{children:"This name will be displayed instead of your email at the top"}),u.jsxs("div",{className:"mt-4 flex items-center",children:[u.jsx(Z,{icon:Be,className:"md:pr-2 pr-1 hover:text-c5 transition cursor-pointer",onClick:f}),t?u.jsxs("form",{className:"w-full",onSubmit:l=>void c(l),children:[u.jsx("input",{className:"outline-none rounded md:p-2 p-1 w-full text-c9",value:i,onChange:l=>s(l.target.value)}),u.jsx("input",{type:"submit",className:"hidden"})]}):i]})]})}var Re="__sak";function xe(n){return n!==void 0&&n.enterprise!==void 0}var Gt=function(){function n(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(function(t){return t.provider==="EMAIL_PASSWORD_PROVIDER"&&t.enforcementState!=="OFF"})}return n}();function Ye(){var n;return n={},n["dependent-sdk-initialized-before-auth"]="Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK.",n}var zt=Ye,le=new he("auth","Firebase",Ye());/**
 * @license
 ...
 */var D=new Pt("@firebase/auth");function Bt(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];D.logLevel<=Je.WARN&&D.warn.apply(D,E(["Auth (".concat(fe,"): ").concat(n)],e,!1))}function Y(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];D.logLevel<=Je.ERROR&&D.error.apply(D,E(["Auth (".concat(fe,"): ").concat(n)],e,!1))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yt(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&($t()||St()||"connection"in navigator)?navigator.onLine:!0}function Xt(){if(typeof navigator>"u")return null;var n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var tn=new Qt(3e4,6e4);function O(n,e){return n.tenantId&&!e.tenantId?b(b({},e),{tenantId:n.tenantId}):e}function V(n,e,t,r,i){return i===void 0&&(i={}),d(this,void 0,void 0,function(){var s=this;return h(this,function(o){return[2,Qe(n,i,function(){return d(s,void 0,void 0,function(){var a,c,f,l;return h(this,function(p){switch(p.label){case 0:return a={},c={},r&&(e==="GET"?c=r:a={body:JSON.stringify(r)}),f=ve(b({key:n.config.apiKey},c)).slice(1),[4,n._getAdditionalHeaders()];case 1:return l=p.sent(),l["Content-Type"]="application/json",n.languageCode&&(l["X-Firebase-Locale"]=n.languageCode),[2,Xe.fetch()(Ze(n,n.config.apiHost,t,f),b({method:e,headers:l,referrerPolicy:"no-referrer"},a))]}})})})]})})}function Qe(n,e,t){return d(this,void 0,void 0,function(){var r,i,s,o,a,c,f,l,p,g;return h(this,function(w){switch(w.label){case 0:n._canInitEmulator=!1,r=b(b({},en),e),w.label=1;case 1:return w.trys.push([1,4,,5]),i=new nn(n),[4,Promise.race([t(),i.promise])];case 2:return s=w.sent(),i.clearNetworkTimeout(),[4,s.json()];case 3:if(o=w.sent(),"needConfirmation"in o)throw W(n,"account-exists-with-different-credential",o);if(s.ok&&!("errorMessage"in o))return[2,o];if(a=s.ok?o.errorMessage:o.error.message,c=a.split(" : "),f=c[0],l=c[1],f==="FEDERATED_USER_ID_ALREADY_LINKED")throw W(n,"credential-already-in-use",o);if(f==="EMAIL_EXISTS")throw W(n,"email-already-in-use",o);if(f==="USER_DISABLED")throw W(n,"user-disabled",o);if(p=r[f]||f.toLowerCase().replace(/[_\s]+/g,"-"),l)throw Jt(n,p,l);return A(n,p),[3,5];case 4:if(g=w.sent(),g instanceof me)throw g;return A(n,"network-request-failed",{message:String(g)}),[3,5];case 5:return[2]}})})}function M(n,e,t,r,i){return i===void 0&&(i={}),d(this,void 0,void 0,function(){var s;return h(this,function(o){switch(o.label){case 0:return[4,V(n,e,t,r,i)];case 1:return s=o.sent(),"mfaPendingCredential"in s&&A(n,"multi-factor-auth-required",{_serverResponse:s}),[2,s]}})})}function Ze(n,e,t,r){var i="".concat(e).concat(t,"?").concat(r);return n.config.emulator?Zt(n.config,i):"".concat(n.config.apiScheme,"://").concat(i)}var nn=function(){function n(e){var t=this;this.auth=e,this.timer=null,this.promise=new Promise(function(r,i){t.timer=setTimeout(function(){return i(te(t.auth,"network-request-failed"))},tn.get())})}return n.prototype.clearNetworkTimeout=function(){clearTimeout(this.timer)},n}();function W(n,e,t){var r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);var i=te(n,e,r);return i.customData._tokenResponse=t,i}function rn(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,V(n,"GET","/v2/recaptchaConfig",O(n,e))]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(n,e){m(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}var de=function(){function n(e){var t=e.uid,r=e.auth,i=e.stsTokenManager,s=pe(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new ln(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=r,this.stsTokenManager=i,this.accessToken=i.accessToken,this.displayName=s.displayName||null,this.email=s.email||null,this.emailVerified=s.emailVerified||!1,this.phoneNumber=s.phoneNumber||null,this.photoURL=s.photoURL||null,this.isAnonymous=s.isAnonymous||!1,this.tenantId=s.tenantId||null,this.providerData=s.providerData?E([],s.providerData,!0):[],this.metadata=new et(s.createdAt||void 0,s.lastLoginAt||void 0)}return n.prototype.getIdToken=function(e){return d(this,void 0,void 0,function(){var t;return h(this,function(r){switch(r.label){case 0:return[4,z(this,this.stsTokenManager.getToken(this.auth,e))];case 1:return t=r.sent(),m(t,this.auth,"internal-error"),this.accessToken===t?[3,3]:(this.accessToken=t,[4,this.auth._persistUserIfCurrent(this)]);case 2:r.sent(),this.auth._notifyListenersIfCurrent(this),r.label=3;case 3:return[2,t]}})})},n.prototype.getIdTokenResult=function(e){return an(this,e)},n.prototype.reload=function(){return dn(this)},n.prototype._assign=function(e){this!==e&&(m(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(function(t){return b({},t)}),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))},n.prototype._clone=function(e){var t=new n(b(b({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t},n.prototype._onReload=function(e){m(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)},n.prototype._notifyReloadListener=function(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e},n.prototype._startProactiveRefresh=function(){this.proactiveRefresh._start()},n.prototype._stopProactiveRefresh=function(){this.proactiveRefresh._stop()},n.prototype._updateTokensIfNecessary=function(e,t){return t===void 0&&(t=!1),d(this,void 0,void 0,function(){var r;return h(this,function(i){switch(i.label){case 0:return r=!1,e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),t?[4,Q(this)]:[3,2];case 1:i.sent(),i.label=2;case 2:return[4,this.auth._persistUserIfCurrent(this)];case 3:return i.sent(),r&&this.auth._notifyListenersIfCurrent(this),[2]}})})},n.prototype.delete=function(){return d(this,void 0,void 0,function(){var e;return h(this,function(t){switch(t.label){case 0:return[4,this.getIdToken()];case 1:return e=t.sent(),[4,z(this,sn(this.auth,{idToken:e}))];case 2:return t.sent(),this.stsTokenManager.clearRefreshToken(),[2,this.auth.signOut()]}})})},n.prototype.toJSON=function(){return b(b({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(function(e){return b({},e)}),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})},Object.defineProperty(n.prototype,"refreshToken",{get:function(){return this.stsTokenManager.refreshToken||""},enumerable:!1,configurable:!0}),n._fromJSON=function(e,t){var r,i,s,o,a,c,f,l,p=(r=t.displayName)!==null&&r!==void 0?r:void 0,g=(i=t.email)!==null&&i!==void 0?i:void 0,w=(s=t.phoneNumber)!==null&&s!==void 0?s:void 0,y=(o=t.photoURL)!==null&&o!==void 0?o:void 0,I=(a=t.tenantId)!==null&&a!==void 0?a:void 0,k=(c=t._redirectEventId)!==null&&c!==void 0?c:void 0,P=(f=t.createdAt)!==null&&f!==void 0?f:void 0,we=(l=t.lastLoginAt)!==null&&l!==void 0?l:void 0,ne=t.uid,be=t.emailVerified,ke=t.isAnonymous,re=t.providerData,Ee=t.stsTokenManager;m(ne&&Ee,e,"internal-error");var gt=Ae.fromJSON(this.name,Ee);m(typeof ne=="string",e,"internal-error"),L(p,e.name),L(g,e.name),m(typeof be=="boolean",e,"internal-error"),m(typeof ke=="boolean",e,"internal-error"),L(w,e.name),L(y,e.name),L(I,e.name),L(k,e.name),L(P,e.name),L(we,e.name);var ie=new n({uid:ne,auth:e,email:g,emailVerified:be,displayName:p,isAnonymous:ke,photoURL:y,phoneNumber:w,tenantId:I,stsTokenManager:gt,createdAt:P,lastLoginAt:we});return re&&Array.isArray(re)&&(ie.providerData=re.map(function(It){return b({},It)})),k&&(ie._redirectEventId=k),ie},n._fromIdTokenResponse=function(e,t,r){return r===void 0&&(r=!1),d(this,void 0,void 0,function(){var i,s;return h(this,function(o){switch(o.label){case 0:return i=new Ae,i.updateFromServerResponse(t),s=new n({uid:t.localId,auth:e,stsTokenManager:i,isAnonymous:r}),[4,Q(s)];case 1:return o.sent(),[2,s]}})})},n}();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Oe=new Map;function U(n){j(n instanceof Function,"Expected a class definition");var e=Oe.get(n);return e?(j(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Oe.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Me(n){var e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(nt(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(mn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(it(e))return"Blackberry";if(st(e))return"Webos";if(tt(e))return"Safari";if((e.includes("chrome/")||gn(e))&&!e.includes("edge/"))return"Chrome";if(rt(e))return"Android";var t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);return(r==null?void 0:r.length)===2?r[1]:"Other"}function mn(n){return n===void 0&&(n=N()),/firefox\//i.test(n)}function tt(n){n===void 0&&(n=N());var e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function gn(n){return n===void 0&&(n=N()),/crios\//i.test(n)}function nt(n){return n===void 0&&(n=N()),/iemobile/i.test(n)}function rt(n){return n===void 0&&(n=N()),/android/i.test(n)}function it(n){return n===void 0&&(n=N()),/blackberry/i.test(n)}function st(n){return n===void 0&&(n=N()),/webos/i.test(n)}function ot(n){return n===void 0&&(n=N()),/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function In(){return Et()&&document.documentMode===10}function _n(n){return n===void 0&&(n=N()),ot(n)||rt(n)||st(n)||it(n)||/windows phone/i.test(n)||nt(n)}function yn(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function at(n,e){e===void 0&&(e=[]);var t;switch(n){case"Browser":t=Me(N());break;case"Worker":t="".concat(Me(N()),"-").concat(n);break;default:t=n}var r=e.length?e.join(","):"FirebaseCore-web";return"".concat(t,"/").concat("JsCore","/").concat(fe,"/").concat(r)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wn(n,e){return e===void 0&&(e={}),d(this,void 0,void 0,function(){return h(this,function(t){return[2,V(n,"GET","/v2/passwordPolicy",O(n,e))]})})}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nn(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}function Pn(n){return new Promise(function(e,t){var r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=function(i){var s=te("internal-error");s.customData=i,t(s)},r.type="text/javascript",r.charset="UTF-8",Nn().appendChild(r)})}var Sn="https://www.google.com/recaptcha/enterprise.js?render=",Rn="recaptcha-enterprise",xn="NO_RECAPTCHA",Cn=function(){function n(e){this.type=Rn,this.auth=ut(e)}return n.prototype.verify=function(e,t){return e===void 0&&(e="verify"),t===void 0&&(t=!1),d(this,void 0,void 0,function(){function r(o){return d(this,void 0,void 0,function(){var a=this;return h(this,function(c){if(!t){if(o.tenantId==null&&o._agentRecaptchaConfig!=null)return[2,o._agentRecaptchaConfig.siteKey];if(o.tenantId!=null&&o._tenantRecaptchaConfigs[o.tenantId]!==void 0)return[2,o._tenantRecaptchaConfigs[o.tenantId].siteKey]}return[2,new Promise(function(f,l){return d(a,void 0,void 0,function(){return h(this,function(p){return rn(o,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(function(g){if(g.recaptchaKey===void 0)l(new Error("recaptcha Enterprise site key undefined"));else{var w=new Gt(g);return o.tenantId==null?o._agentRecaptchaConfig=w:o._tenantRecaptchaConfigs[o.tenantId]=w,f(w.siteKey)}}).catch(function(g){l(g)}),[2]})})})]})})}function i(o,a,c){var f=window.grecaptcha;xe(f)?f.enterprise.ready(function(){f.enterprise.execute(o,{action:e}).then(function(l){a(l)}).catch(function(){a(xn)})}):c(Error("No reCAPTCHA enterprise script loaded."))}var s=this;return h(this,function(o){return[2,new Promise(function(a,c){r(s.auth).then(function(f){if(!t&&xe(window.grecaptcha))i(f,a,c);else{if(typeof window>"u"){c(new Error("RecaptchaVerifier is only supported in browser"));return}Pn(Sn+f).then(function(){i(f,a,c)}).catch(function(l){c(l)})}}).catch(function(f){c(f)})})]})})},n}();function je(n,e,t,r){return r===void 0&&(r=!1),d(this,void 0,void 0,function(){var i,s,o;return h(this,function(a){switch(a.label){case 0:i=new Cn(n),a.label=1;case 1:return a.trys.push([1,3,,5]),[4,i.verify(t)];case 2:return s=a.sent(),[3,5];case 3:return a.sent(),[4,i.verify(t,!0)];case 4:return s=a.sent(),[3,5];case 5:return o=b({},e),r?Object.assign(o,{captchaResp:s}):Object.assign(o,{captchaResponse:s}),Object.assign(o,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(o,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),[2,o]}})})}function An(n,e){var t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(U);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var J=function(){function n(e,t){this.providerId=e,this.signInMethod=t}return n.prototype.toJSON=function(){return S("not implemented")},n.prototype._getIdTokenResponse=function(e){return S("not implemented")},n.prototype._linkToIdToken=function(e,t){return S("not implemented")},n.prototype._getReauthenticationResolver=function(e){return S("not implemented")},n}();function On(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,V(n,"POST","/v1/accounts:update",e)]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ae(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,M(n,"POST","/v1/accounts:signInWithPassword",O(n,e))]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ln(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,M(n,"POST","/v1/accounts:signInWithEmailLink",O(n,e))]})})}function Un(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,M(n,"POST","/v1/accounts:signInWithEmailLink",O(n,e))]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,M(n,"POST","/v1/accounts:signInWithIdp",O(n,e))]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ue;function Dn(n,e){return d(this,void 0,void 0,function(){return h(this,function(t){return[2,M(n,"POST","/v1/accounts:signInWithPhoneNumber",O(n,e))]})})}function jn(n,e){return d(this,void 0,void 0,function(){var t;return h(this,function(r){switch(r.label){case 0:return[4,M(n,"POST","/v1/accounts:signInWithPhoneNumber",O(n,e))];case 1:if(t=r.sent(),t.temporaryProof)throw W(n,"account-exists-with-different-credential",t);return[2,t]}})})}var Fn=(ue={},ue.USER_NOT_FOUND="user-not-found",ue);function Vn(n,e){return d(this,void 0,void 0,function(){var t;return h(this,function(r){return t=b(b({},e),{operation:"REAUTH"}),[2,M(n,"POST","/v1/accounts:signInWithPhoneNumber",O(n,t),Fn)]})})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Gn="http://localhost",Ve=function(n){T(e,n);function e(t,r){var i=n.call(this,t,t)||this;return i.pendingToken=r,i}return e.prototype._getIdTokenResponse=function(t){var r=this.buildRequest();return C(t,r)},e.prototype._linkToIdToken=function(t,r){var i=this.buildRequest();return i.idToken=r,C(t,i)},e.prototype._getReauthenticationResolver=function(t){var r=this.buildRequest();return r.autoCreate=!1,C(t,r)},e.prototype.toJSON=function(){return{signInMethod:this.signInMethod,providerId:this.providerId,pendingToken:this.pendingToken}},e.fromJSON=function(t){var r=typeof t=="string"?JSON.parse(t):t,i=r.providerId,s=r.signInMethod,o=r.pendingToken;return!i||!s||!o||i!==s?null:new e(i,o)},e._create=function(t,r){return new e(t,r)},e.prototype.buildRequest=function(){return{requestUri:Gn,returnSecureToken:!0,pendingToken:this.pendingToken}},e}(J);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var zn="saml.";(function(n){T(e,n);function e(t){return m(t.startsWith(zn),"argument-error"),n.call(this,t)||this}return e.credentialFromResult=function(t){return e.samlCredentialFromTaggedObject(t)},e.credentialFromError=function(t){return e.samlCredentialFromTaggedObject(t.customData||{})},e.credentialFromJSON=function(t){var r=Ve.fromJSON(t);return m(r,"argument-error"),r},e.samlCredentialFromTaggedObject=function(t){var r=t._tokenResponse;if(!r)return null;var i=r,s=i.pendingToken,o=i.providerId;if(!s||!o)return null;try{return Ve._create(o,s)}catch{return null}},e})(ct);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function er(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function tr(n){Ne(new Pe("auth",function(e,t){var r=t.options,i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),o=e.getProvider("app-check-internal"),a=i.options,c=a.apiKey,f=a.authDomain;m(c&&!c.includes(":"),"invalid-api-key",{appName:i.name});var l={apiKey:c,authDomain:f,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:at(n)},p=new En(i,s,o,l);return An(p,r),p},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(function(e,t,r){var i=e.getProvider("auth-internal");i.initialize()})),Ne(new Pe("auth-internal",function(e){var t=ut(e.getProvider("auth").getImmediate());return function(r){return new Zn(r)}(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Se(He,We,er(n)),Se(He,We,"esm5")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ft=function(){function n(e,t){this.storageRetriever=e,this.type=t}return n.prototype._isAvailable=function(){try{return this.storage?(this.storage.setItem(Re,"1"),this.storage.removeItem(Re),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}},n.prototype._set=function(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()},n.prototype._get=function(e){var t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)},n.prototype._remove=function(e){return this.storage.removeItem(e),Promise.resolve()},Object.defineProperty(n.prototype,"storage",{get:function(){return this.storageRetriever()},enumerable:!1,configurable:!0}),n}();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(n){T(e,n);function e(){return n.call(this,function(){return window.sessionStorage},"SESSION")||this}return e.prototype._addListener=function(t,r){},e.prototype._removeListener=function(t,r){},e.type="SESSION",e})(ft);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
