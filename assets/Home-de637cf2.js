 ...
 */var D=new Pt("@firebase/auth");function Qt(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];D.logLevel<=Be.WARN&&D.warn.apply(D,E(["Auth (".concat(fe,"): ").concat(n)],e,!1))}function Y(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];D.logLevel<=Be.ERROR&&D.error.apply(D,E(["Auth (".concat(fe,"): ").concat(n)],e,!1))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tn(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(en()||St()||"connection"in navigator)?navigator.onLine:!0}function nn(){if(typeof navigator>"u")return null;var n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var rn=function(){function n(e,t){this.shortDelay=e,this.longDelay=t,j(t>e,"Short delay should be less than long delay!"),this.isMobile=bt()||wt()}return n.prototype.get=function(){return tn()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)},n}();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Me(n){var e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(nt(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Tn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(it(e))return"Blackberry";if(st(e))return"Webos";if(tt(e))return"Safari";if((e.includes("chrome/")||bn(e))&&!e.includes("edge/"))return"Chrome";if(rt(e))return"Android";var t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);return(r==null?void 0:r.length)===2?r[1]:"Other"}function Tn(n){return n===void 0&&(n=N()),/firefox\//i.test(n)}function tt(n){n===void 0&&(n=N());var e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function bn(n){return n===void 0&&(n=N()),/crios\//i.test(n)}function nt(n){return n===void 0&&(n=N()),/iemobile/i.test(n)}function rt(n){return n===void 0&&(n=N()),/android/i.test(n)}function it(n){return n===void 0&&(n=N()),/blackberry/i.test(n)}function st(n){return n===void 0&&(n=N()),/webos/i.test(n)}function ot(n){return n===void 0&&(n=N()),/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function wn(){return Et()&&document.documentMode===10}function kn(n){return n===void 0&&(n=N()),ot(n)||rt(n)||st(n)||it(n)||/windows phone/i.test(n)||nt(n)}function En(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $n=function(){function n(){this.providerId=n.PROVIDER_ID}return n.credential=function(e,t){return Fe._fromEmailAndPassword(e,t)},n.credentialWithLink=function(e,t){var r=Bn.parseLink(t);return m(r,"argument-error"),Fe._fromEmailAndCode(e,r.code,r.tenantId)},n.PROVIDER_ID="password",n.EMAIL_PASSWORD_SIGN_IN_METHOD="password",n.EMAIL_LINK_SIGN_IN_METHOD="emailLink",n}();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Yn="http://localhost",Ve=function(n){b(e,n);function e(t,r){var i=n.call(this,t,t)||this;return i.pendingToken=r,i}return e.prototype._getIdTokenResponse=function(t){var r=this.buildRequest();return C(t,r)},e.prototype._linkToIdToken=function(t,r){var i=this.buildRequest();return i.idToken=r,C(t,i)},e.prototype._getReauthenticationResolver=function(t){var r=this.buildRequest();return r.autoCreate=!1,C(t,r)},e.prototype.toJSON=function(){return{signInMethod:this.signInMethod,providerId:this.providerId,pendingToken:this.pendingToken}},e.fromJSON=function(t){var r=typeof t=="string"?JSON.parse(t):t,i=r.providerId,s=r.signInMethod,o=r.pendingToken;return!i||!s||!o||i!==s?null:new e(i,o)},e._create=function(t,r){return new e(t,r)},e.prototype.buildRequest=function(){return{requestUri:Yn,returnSecureToken:!0,pendingToken:this.pendingToken}},e}(B);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Qn=function(n){b(e,n);function e(t,r,i,s){var o=this,a;return o=n.call(this,r.code,r.message)||this,o.operationType=i,o.user=s,Object.setPrototypeOf(o,e.prototype),o.customData={appName:t.name,tenantId:(a=t.tenantId)!==null&&a!==void 0?a:void 0,_serverResponse:r.customData._serverResponse,operationType:i},o}return e._fromErrorAndOperation=function(t,r,i,s){return new e(t,r,i,s)},e}(me);function lt(n,e,t,r){var i=e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n);return i.catch(function(s){throw s.code==="auth/".concat("multi-factor-auth-required")?Qn._fromErrorAndOperation(n,s,e,r):s})}function Zn(n,e,t){return t===void 0&&(t=!1),d(this,void 0,void 0,function(){var r,i,s,o,a,c;return h(this,function(f){switch(f.label){case 0:return i=z,s=[n],a=(o=e)._linkToIdToken,c=[n.auth],[4,n.getIdToken()];case 1:return[4,i.apply(void 0,s.concat([a.apply(o,c.concat([f.sent()])),t]))];case 2:return r=f.sent(),[2,_e._forOperation(n,"link",r)]}})})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function or(n){Ne(new Pe("auth",function(e,t){var r=t.options,i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),o=e.getProvider("app-check-internal"),a=i.options,c=a.apiKey,f=a.authDomain;m(c&&!c.includes(":"),"invalid-api-key",{appName:i.name});var l={apiKey:c,authDomain:f,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:at(n)},p=new Cn(i,s,o,l);return Dn(p,r),p},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(function(e,t,r){var i=e.getProvider("auth-internal");i.initialize()})),Ne(new Pe("auth-internal",function(e){var t=ut(e.getProvider("auth").getImmediate());return function(r){return new ir(r)}(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Se(He,We,sr(n)),Se(He,We,"esm5")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(n){b(e,n);function e(){return n.call(this,function(){return window.sessionStorage},"SESSION")||this}return e.prototype._addListener=function(t,r){},e.prototype._removeListener=function(t,r){},e.type="SESSION",e})(ft);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
